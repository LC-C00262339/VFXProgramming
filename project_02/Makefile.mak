...
BLEND_FILE		:= projectscene.blend		# Name of Blender File (Project file)
VIDEO_FILE		:= production.blend   # Name of Video Edit File
# BLEND_SCRIPT	:=
# render directory
RENDER_DIR		:= render
...
RENDER_FRMS		:= 1..80					# edit frames required
# Render Target
RENDER_TARGET	:= //${RENDER_DIR}//${FRAMES}

# Movie File Render
RENDER_SCRIPT	:= render.py			# Contains commands and setting to render movie
MOVIE_FILE		:= projectscene.mp4			# Rendered movie output file
